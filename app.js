...
const fs = require('fs');
const url = "https://en.wikipedia.org/wiki/Music";//FIRST, find a url of a page on Wikipedia that you are interested in
const jsonPath = "./json/"; 
...
function getAllImages(soupTag){
    ...
    for(let i = 0; i < imgs.length; i++){
        ...
        //if attrs contains sources then got those source
        if('src' in attrs){
            let src = attrs.src;
